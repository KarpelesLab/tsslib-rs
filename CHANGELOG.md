...
## [0.2.9](https://github.com/KarpelesLab/tsslib-rs/compare/v0.2.8...v0.2.9) - 2026-09-20

### Fixed

- allow threshold 0 (1-of-n) in Feldman VSS
...
- add non-blocking try_result() to all ceremony party types
